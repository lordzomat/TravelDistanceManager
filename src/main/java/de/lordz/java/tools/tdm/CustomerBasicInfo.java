...
public class CustomerBasicInfo extends JPanel {
    ...
    public CustomerBasicInfo() {
        ...
        springLayout.putConstraint(SpringLayout.NORTH, this.textFieldPostcode, 6, SpringLayout.SOUTH,
                this.textFieldStreet);
        ...
        springLayout.putConstraint(SpringLayout.NORTH, this.textFieldCity, 6, SpringLayout.SOUTH,
                this.textFieldPostcode);
        ...
        springLayout.putConstraint(SpringLayout.NORTH, this.textFieldDistance, 6, SpringLayout.SOUTH,
                this.textFieldCity);
