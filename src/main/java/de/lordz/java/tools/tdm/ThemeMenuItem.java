...
public class ThemeMenuItem extends JMenuItem {
    ...
    /**
     * Creates a <code>ThemeMenuItem</code> with the specified text and theme class name.
     *
     * @param text the text of the <code>ThemeMenuItem</code>
     * @param themeClassName the name of the theme class of the <code>ThemeMenuItem</code>
     */
